...
int main(int argc, char **argv) {
  ...
  cout << endl
       << "Artificial Muscle Simulator, Max Braun, Osaka University, Yuragi "
          "Project, 2008"
       << endl;
  ...
  cout << endl
       ...
       << " --simple"
       << "\t\t"
       << "Faster simulation without display or interaction" << endl
       << " --step x"
       << "\t\t"
       << "Set ODE simulation step size to x (default: " << DEFAULT_STEP << ")"
       << endl
       << " --verbose"
       << "\t\t"
       << "Print more information on startup" << endl;
