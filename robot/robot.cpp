...
RoboticArm::RoboticArm() : Robot() {
	...
	Box* rib_1_2_rest = new Box(
		world, space,
		rib_1_2_rest_position,
		10, // mass
		1, // density
	...
	Box* rib_3_4_rest = new Box(
		world, space,
		rib_3_4_rest_position,
		10, // mass
		1, // density
	...
	Box* rib_5_6_rest_1 = new Box(
		world, space,
		rib_5_6_rest_1_position,
		10, // mass
		1, // density
	...
	Box* rib_5_6_rest_2 = new Box(
		world, space,
		rib_5_6_rest_2_position,
		10, // mass
		1, // density
	...
	Box* rib_7_8_rest_1 = new Box(
		world, space,
		rib_7_8_rest_1_position,
		10, // mass
		1, // density
	...
	Box* rib_7_8_rest_2 = new Box(
		world, space,
		rib_7_8_rest_2_position,
		10, // mass
		1, // density
	...
	Box* rib_9_10_rest_1 = new Box(
		world, space,
		rib_9_10_rest_1_position,
		10, // mass
		1, // density
		sqrt(70*70+80*80)+5*tan(atan(70.0/80)/2.0), // x
		30, // y
	...
	dVector3 rib_9_10_rest_2_position = {-250+220-70-45, 265, 170-35-85};
	Box* rib_9_10_rest_2 = new Box(
		world, space,
		rib_9_10_rest_2_position,
		10, // mass
		1, // density
		sqrt(100*100+10*10)+5*tan(atan(70.0/80)/2.0), // x
		30, // y
	...
	Box* rib_11_12_rest_1 = new Box(
		world, space,
		rib_11_12_rest_1_position,
		10, // mass
		1, // density
		sqrt(50*50+60*60)+5*tan(atan(50.0/60)/2.0), // x
		30, // y
	...
	dVector3 rib_11_12_rest_2_position = {-250+220-60-35, 225, 170-25-65};
	Box* rib_11_12_rest_2 = new Box(
		world, space,
		rib_11_12_rest_2_position,
		10, // mass
		1, // density
	...
	Box* scapula_rest_1 = new Box(
		world, space,
		scapula_rest_1_position,
		80, // mass
		1, // density
	...
	scapula_rest_1->rotate(180/M_PI*acos(70/(5*sqrt(34*(17-sqrt(93))))), z_axis);
	scapula_parts.push_back(scapula_rest_1);
	
	dVector3 scapula_rest_2_position = {-250+60-35-30, 330+80, -120};
	Box* scapula_rest_2 = new Box(
		world, space,
		scapula_rest_2_position,
		80, // mass
		1, // density
		30, // x
		80, // y
	...
	scapula_rest_2->rotate(180/M_PI*acos(70/(5*sqrt(34*(17-sqrt(93))))), z_axis);
	...
	CappedCylinder* radius_head = new CappedCylinder(
		world, space,
		radius_head_position,
		20, // mass
		1, // density
		6, // radius
		40 // length
	...
	CappedCylinder* radius = new CappedCylinder(
		world, space,
		radius_position,
		100, // mass
		1, // density
	...
	CappedCylinder* ulna_head = new CappedCylinder(
		world, space,
		ulna_head_position,
		20, // mass
		1, // density
	...
	CappedCylinder* ulna = new CappedCylinder(
		world, space,
		ulna_position,
		100, // mass
		1, // density
	...
	Box* medius_rest = new Box(
		world, space,
		medius_rest_position,
		10, // mass
		1, // density
		16, // x
		8, // y
	...
	Muscle* muscle_0 = new Muscle(
		world, space,
		muscle_0_start_at, muscle_0_start_control,
		muscle_0_end_control, muscle_0_end_at,
		75, 300
	);
	...
	Muscle* muscle_1 = new Muscle(
		world, space,
		muscle_1_start_at, muscle_1_start_control,
		muscle_1_end_conrol, muscle_1_end_at,
		75, 300
	);
	...
	Muscle* muscle_2 = new Muscle(
		world, space,
		muscle_2_start_at, muscle_2_start_control,
		muscle_2_end_control, muscle_2_end_at,
		75, 200
	);
	...
	Muscle* muscle_3 = new Muscle(
		world, space,
		muscle_3_start_at, muscle_3_start_control,
		muscle_3_end_control, muscle_3_end_at,
		75, 300
	);
	...
	Muscle* muscle_4 = new Muscle(
		world, space,
		muscle_4_start_at, muscle_4_start_control,
		muscle_4_end_control, muscle_4_end_at,
		75, 300
	);
	...
	Muscle* muscle_5 = new Muscle(
		world, space,
		muscle_5_start_at, muscle_5_start_control,
		muscle_5_end_control, muscle_5_end_at,
		90, 300
	);
	...
	Muscle* muscle_6 = new Muscle(
		world, space,
		muscle_6_start_at, muscle_6_start_control,
		muscle_6_end_control, muscle_6_end_at,
		60, 200
	);
	...
	Muscle* muscle_7 = new Muscle(
		world, space,
		muscle_7_start_at, muscle_7_start_control,
		muscle_7_end_control, muscle_7_end_at,
		60, 350
	);
	...
	Muscle* muscle_8 = new Muscle(
		world, space,
		muscle_8_start_at, muscle_8_start_control,
		muscle_8_end_control, muscle_8_end_at,
		60, 200
	);
	...
	Muscle* muscle_9 = new Muscle(
		world, space,
		muscle_9_start_at, muscle_9_start_control,
		muscle_9_end_control, muscle_9_end_at,
		60, 200
	);
